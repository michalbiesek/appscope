...
int           scope_mq_timedsend(mqd_t, const char *, size_t , unsigned int, const struct timespec *);
ssize_t       scope_mq_receive(mqd_t, char *, size_t, unsigned int *);
ssize_t       scope_mq_timedreceive(mqd_t, char *, size_t, unsigned int *, const struct timespec *);
