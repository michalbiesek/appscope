...
int                     scopelibc___fxstat(int, int, struct stat *);
int                     scopelibc___xstat(int, const char *, struct stat *);
...
int
scope___fxstat(int ver, int fd, struct stat *buf)
{
    return scopelibc___fxstat(ver, fd, buf);
}
