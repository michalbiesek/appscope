...
/*
 * Save static loader (ldscope) into namespace filesystem.
 *
 * Returns TRUE in case of success, FALSE otherwise.
 */
static bool
saveLdscopeInNamespaceFs(char* ldscopeMem, size_t ldscopeSize)
{
    bool status = FALSE;
...
switch_namespace(pid_t hostPid)
{
    ...
    */
    ...
    status = saveLdscopeInNamespaceFs(ldscopeMem, ldscopeSize);
 ...
 */
bool
nsIsPidInChildNs(pid_t pid, pid_t *ns_pid)
{
...
{
    if (switch_namespace(parentPid) == FALSE) {
