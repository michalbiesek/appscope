...
class ElasticIndexAndSearchTest(ApplicationTest):
    ...
    def __connect_to_es(self):
        ...
        elasticsearch = Elasticsearch(hosts=[{"scheme": config.scheme, "host": config.host, "port": config.port}])
...
if __name__ == '__main__':
    ...
    logging.info("Start ElasticSearch main")
    es = Elasticsearch(hosts=[{"scheme": config.scheme, "host": config.host, "port": config.port}])
